...
namespace Reclaimer.Blam.Halo5
{
    public partial class scenario_structure_bsp : ContentTagDefinition<Scene>, IContentProvider<Model>
    {
        ...
        private Model GetModelContent()
        {
            ...
            {
                if (model.Meshes[instanceGroup.SectionIndex] == null)
                    continue;
                ...
                (model.Meshes[instanceGroup.SectionIndex].PositionBounds, model.Meshes[instanceGroup.SectionIndex].TextureBounds) = (posBounds, texBounds);
            }
